...
const EditProfile = () => {
    ...
    const [sidenNavElements, setSidenNavElements] = useState([{ elemName: "Edit Username and Password", active: false, path: "edituandp" },
                ...
                <div className="sidebar" >
                    <ul >
                        {sidenNavElements.map((elem, index) => {
                            return (
                                <Link to={elem.path}>
                                    <li key={index} className={elem.active ? "active" : ""}
